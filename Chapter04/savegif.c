...
enum AVPixelFormat target_format = AV_PIX_FMT_RGB8; // gif的像素格式
...
int init_sws_context(void) {
	...
	av_image_alloc(rgb_frame->data, rgb_frame->linesize, video_decode_ctx->width, video_decode_ctx->height,
		target_format, 1);
	return 0;
}
...
int main(int argc, char** argv) {
	...
	//avcodec_close(gif_encode_ctx); // 释放视频解码器的实例
